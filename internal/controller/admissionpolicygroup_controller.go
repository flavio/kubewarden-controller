...
func (r *AdmissionPolicyGroupReconciler) findAllPoliciesForControllerConfigMap(ctx context.Context, _ client.Object) []reconcile.Request {
	return findAllAdmissionPolicyGroups(ctx, r.Client, r.Log)
}
